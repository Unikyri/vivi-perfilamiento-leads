(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();let y=1,z=!1;const D=[{mensaje_id:"m1",autor:"VIVI",tipo_contenido:"TEXTO",texto:"¡Hola Ana! 👋 Como afiliada tienes un subsidio de hasta $52,5M. ¿Sueñas con comprar este año?",creado_en:new Date().toISOString(),adjunto:null}];function X(a){return{lead_id:a,estado:"PERFILANDO",turno_en_proceso:z,mensajes:[...D]}}const Y={cupo_10:{usados:1,porcentaje_ventana:10},leads:[{lead_id:"mock-1",nombre:"Ana Rodríguez",estado:"ENTREGADO",ruta:"ASESOR",afiliado:!0,semaforo:"VERDE",prioridad:.91,resumen:"Afiliada cat. A · presupuesto $166.8M · intención alta",actualizado_en:new Date().toISOString()},{lead_id:"mock-2",nombre:"Carlos Martínez",estado:"PERFILANDO",ruta:"ASESOR",afiliado:!1,semaforo:"AMBAR",prioridad:.78,resumen:"No afiliado · presupuesto $210M · intención media",actualizado_en:new Date().toISOString()},{lead_id:"mock-3",nombre:"Luisa Gómez",estado:"CALIFICADO",ruta:"NUTRICION",afiliado:!0,semaforo:"VERDE",prioridad:.85,resumen:"Afiliada cat. B · presupuesto $145M · requiere plan cuota inicial",actualizado_en:new Date().toISOString()}]},W={"mock-1":{ficha_id:"f1",lead_id:"mock-1",generada_en:new Date().toISOString(),confianza_perfil:.94,banda_advertencia:null,identificacion:{nombre:"Ana Rodríguez",afiliada:!0,categoria:"A",telefono:"+57 300 123 4567"},capacidad:{presupuesto_max:1668e5,credito_max:1143e5,subsidio_aplicable:525e5,recursos_propios:12e6,ratio:.28,confianza:.94,desglose:[{concepto:"Subsidio Mi Casa Ya / Caja",monto:525e5,regla:"Afiliado Cat A",fuente:"VERIFICADO_BASE"},{concepto:"Preaprobado Bancolombia",monto:1143e5,regla:"Capacidad de endeudamiento 30%",fuente:"INFERIDO"},{concepto:"Ahorro Declarado",monto:12e6,regla:"Declarado en chat",fuente:"DECLARADO"}]},perfil:{ingreso:{valor:26e5,fuente:"VERIFICADO_BASE",confianza:.95,requiere_confirmacion:!1,actualizado_en:new Date().toISOString()}},intencion:{nivel:"ALTA",confianza:"ALTA",senales:["Busca comprar antes de 6 meses","Tiene ahorro inicial preparado","Responde inmediatamente a Vivi"]},recomendaciones:[{proyecto_id:"mongui",nombre:"Monguí",zona:"Ciudadela Maiporé - Soacha",precio_desde:15647e4,razon:"Tu presupuesto cubre el 100% de la cuota inicial",vecinos:622,tasa_desistimiento:.12,brochure_url:"https://heyzine.com/flip-book/866af8f6a6.html",recorrido_360_url:"https://storage.net-fs.com/hosting/7532170/19/"}],beneficios:["Subsidio de vivienda Colsubsidio hasta $52,5M","Tasa preferencial crédito hipotecario"],argumentos_venta:["Cuota estimada mensual ($650k) es MENOR al arriendo promedio de la zona ($850k)","Entrega inmediata en 2026"],alerta_desistimiento:{activa:!1,tasa_vecinos:.12,detalle:null},consume_cupo_10:!1},"mock-2":{ficha_id:"f2",lead_id:"mock-2",generada_en:new Date().toISOString(),confianza_perfil:.82,banda_advertencia:"No afiliado a Colsubsidio — consume cupo del 10% regulatorio",identificacion:{nombre:"Carlos Martínez",afiliada:!1,categoria:"N/A",telefono:"+57 311 987 6543"},capacidad:{presupuesto_max:21e7,credito_max:18e7,subsidio_aplicable:0,recursos_propios:3e7,ratio:.32,confianza:.82,desglose:[{concepto:"Crédito solicitado",monto:18e7,regla:"Ingresos independientes",fuente:"DECLARADO"},{concepto:"Cuota Inicial Propia",monto:3e7,regla:"Recursos declarados",fuente:"DECLARADO"}]},perfil:{},intencion:{nivel:"MEDIA",confianza:"MEDIA",senales:["Interesado en proyectos VIS y no VIS","Evaluando opciones de crédito"]},recomendaciones:[],beneficios:["Opción de crédito con aliados de la caja"],argumentos_venta:["Proyecto Versalles cuenta con certificación EDGE para ahorro energético"],alerta_desistimiento:{activa:!1,tasa_vecinos:.08,detalle:null},consume_cupo_10:!0}},w={mongui:{proyecto_id:"mongui",nombre:"Monguí",muestras:312,afiliacion:{afiliados:198,no_afiliados:114},categoria:{"Cat A":110,"Cat B":68,"Cat C":20,"No Afiliado":114},rango_edad:{"18-25":25,"26-35":165,"36-45":82,"46+":40},tasa_desistimiento:.11,actualizado_en:new Date().toISOString()},macarena:{proyecto_id:"macarena",nombre:"La Macarena",muestras:185,afiliacion:{afiliados:140,no_afiliados:45},categoria:{"Cat A":85,"Cat B":42,"Cat C":13,"No Afiliado":45},rango_edad:{"18-25":15,"26-35":95,"36-45":50,"46+":25},tasa_desistimiento:.08,actualizado_en:new Date().toISOString()},versalles:{proyecto_id:"versalles",nombre:"Versalles",muestras:142,afiliacion:{afiliados:85,no_afiliados:57},categoria:{"Cat A":40,"Cat B":32,"Cat C":13,"No Afiliado":57},rango_edad:{"18-25":10,"26-35":70,"36-45":42,"46+":20},tasa_desistimiento:.15,actualizado_en:new Date().toISOString()}};function K(a){z=!0,setTimeout(()=>{y++;const e=/proyecto|comprar|vivienda|casa|apto/i.test(a),t={mensaje_id:`m${y}`,autor:"VIVI",tipo_contenido:e?"TARJETAS_PROYECTOS":"TEXTO",texto:e?"Basándome en tu perfil, estos proyectos te pueden interesar:":"¡Qué bueno saberlo! ¿Te interesaría que exploremos opciones de vivienda según tu presupuesto?",creado_en:new Date().toISOString(),adjunto:e?{recomendaciones:[{proyecto_id:"mongui",nombre:"Monguí",zona:"Ciudadela Maiporé - Soacha",precio_desde:15647e4,razon:"Tu presupuesto cubre el 100% de la cuota inicial",vecinos:622,tasa_desistimiento:.12,brochure_url:"https://heyzine.com/flip-book/866af8f6a6.html",recorrido_360_url:"https://storage.net-fs.com/hosting/7532170/19/"},{proyecto_id:"macarena",nombre:"La Macarena",zona:"Ciudadela Maiporé - Soacha",precio_desde:12834e4,razon:"El más económico de la zona, ideal para tu ingreso",vecinos:374,tasa_desistimiento:.08,brochure_url:"https://heyzine.com/flip-book/b168b2f5ba.html",recorrido_360_url:""},{proyecto_id:"versalles",nombre:"Versalles",zona:"Ciudadela Maiporé - Soacha",precio_desde:1952e5,razon:"Certificación EDGE, ahorro en servicios",vecinos:174,tasa_desistimiento:.15,brochure_url:"https://heyzine.com/flip-book/be784b0d5c.html",recorrido_360_url:"https://shape.com.co/360/COLSUBSIDIO-Versalles_APTOA"}]}:null};D.push(t),z=!1},2e3)}function Q(){const a=window.fetch;window.fetch=async(e,t)=>{const o=e.toString(),n=((t==null?void 0:t.method)??"GET").toUpperCase(),i=(s,r=200)=>new Response(JSON.stringify(s),{status:r,headers:{"Content-Type":"application/json"}});if(o.includes("/conversacion")&&n==="GET"){const s=o.match(/\/leads\/([^/]+)\/conversacion/);return i(X(s?s[1]:"mock-1"))}if(o.includes("/mensajes")&&n==="POST"){y++;let s={};try{s=JSON.parse((t==null?void 0:t.body)||"{}")}catch{s={}}const r=s.tipo==="AUDIO";return D.push({mensaje_id:`m${y}`,autor:"LEAD",tipo_contenido:"TEXTO",texto:r?"🎙️ [Nota de voz]":s.texto||"",creado_en:new Date().toISOString(),adjunto:r?{audio_original:!0}:null}),K(r?"audio":s.texto||""),i({mensaje_id:`m${y}`,turno_en_proceso:!0},201)}if(o.includes("/ficha")&&n==="GET"){const s=o.match(/\/leads\/([^/]+)\/ficha/),r=s?s[1]:"mock-1",c=W[r];return c?i(c):i({error:{codigo:"FICHA_NO_DISPONIBLE",mensaje:"Ficha aún no disponible"}},404)}if(o.includes("/gerencia/buyer-persona")&&n==="GET"){const r=new URL(o,"http://localhost").searchParams.get("proyecto_id")??"mongui",c=w[r]??w.mongui;return i(c)}if(o.includes("/demo/tiempo")&&n==="POST")return i({fecha_simulada:new Date().toISOString(),hitos_disparados:2});if(o.includes("/demo/reiniciar")&&n==="POST")return D.length=1,i({reiniciado:!0,fecha_simulada:new Date().toISOString()});if(o.endsWith("/api/leads")&&n==="POST"){let s={};try{s=JSON.parse((t==null?void 0:t.body)||"{}")}catch{s={}}const c={ana:"mock-1",carlos:"mock-2",luisa:"mock-3"}[s.precargado_id??"ana"]??"mock-1";return i({lead_id:c,estado:"PERFILANDO",afiliado_detectado:c!=="mock-2"},201)}return o.endsWith("/api/leads")&&n==="GET"?i(Y):a(e,t)},console.info("[mock] servidor simulado completo activo (Chat + Ficha + Cola + Gerencia + Demo)")}const M={leadActivo:null,conversacion:null,cola:null,tabActiva:"cola"},G=[];function S(){return M}function b(a){Object.assign(M,a),G.forEach(e=>e(M))}function Z(a){G.push(a)}const ee="/api";class h extends Error{constructor(e,t,o){super(t),this.codigo=e,this.estadoHTTP=o,this.name="ErrorAPI"}}async function f(a,e){var o,n;const t=await fetch(`${ee}${a}`,{headers:{"Content-Type":"application/json"},...e});if(!t.ok){const i=await t.json().catch(()=>null);throw new h(((o=i==null?void 0:i.error)==null?void 0:o.codigo)??"ERROR_INTERNO",((n=i==null?void 0:i.error)==null?void 0:n.mensaje)??`HTTP ${t.status}`,t.status)}return await t.json()}const p={crearLead:a=>f("/leads",{method:"POST",body:JSON.stringify({precargado_id:a,fuente:"DEMO"})}),enviarTexto:(a,e)=>f(`/leads/${a}/mensajes`,{method:"POST",body:JSON.stringify({tipo:"TEXTO",texto:e})}),enviarAudio:(a,e,t,o)=>f(`/leads/${a}/mensajes`,{method:"POST",body:JSON.stringify({tipo:"AUDIO",audio_base64:e,mime:t,duracion_s:o})}),conversacion:a=>f(`/leads/${a}/conversacion`),cola:()=>f("/leads"),ficha:a=>f(`/leads/${a}/ficha`),buyerPersona:a=>f(`/gerencia/buyer-persona${a?`?proyecto_id=${a}`:""}`),avanzarTiempo:a=>f("/demo/tiempo",{method:"POST",body:JSON.stringify({avanzar_hasta:a})}),reiniciar:()=>f("/demo/reiniciar",{method:"POST"})};function ae(a,e){a.innerHTML=e.map(te).join("")}function te(a){var s,r;if(a.tipo_contenido==="SISTEMA")return`<div class="pildora-sistema">${A(a.texto)}</div>`;const e=a.autor==="LEAD"?"derecha":"izquierda",t=new Date(a.creado_en).toLocaleTimeString("es-CO",{hour:"2-digit",minute:"2-digit"}),o=a.autor==="LEAD"?'<span class="chulos">✓✓</span>':"",n=(s=a.adjunto)!=null&&s.audio_original?'<span class="icono-audio" aria-label="nota de voz">🎙️</span>':"",i=(r=a.adjunto)!=null&&r.recomendaciones?oe(a.adjunto.recomendaciones):"";return`
    ...
    </article>`).join("")}</div>`}function P(a,e){a.classList.toggle("visible",e)}function ne(a){a.innerHTML=`
  ...
  `}function A(a){const e=document.createElement("div");return e.textContent=a,e.innerHTML}const ie=60,se=1500,re=300;let _=null,O=!1,v=null,E=[],T=null,g=0;function ce(a){ne(a);const e=document.getElementById("contenedor-mensajes"),t=document.getElementById("mensajes-scroll"),o=document.getElementById("indicador-escribiendo"),n=document.getElementById("input-mensaje"),i=document.getElementById("btn-enviar"),s=document.getElementById("btn-mic"),r=document.getElementById("mic-grabando"),c=document.getElementById("contador-mic"),d=document.getElementById("btn-detener-mic"),l=document.getElementById("btn-nuevos");n.addEventListener("keydown",u=>{u.key==="Enter"&&!u.shiftKey&&(u.preventDefault(),B(n))}),i.addEventListener("click",()=>B(n)),s.addEventListener("click",()=>de(s,r,c,n,i)),d.addEventListener("click",()=>q(s,r,n,i)),t.addEventListener("scroll",()=>{O=t.scrollHeight-t.scrollTop-t.clientHeight>80,O||l.classList.remove("visible")}),l.addEventListener("click",()=>{t.scrollTop=t.scrollHeight,l.classList.remove("visible"),O=!1}),setInterval(()=>N(e,t,o,l),se),N(e,t,o,l)}async function N(a,e,t,o){const n=S();if(n.leadActivo)try{const i=await p.conversacion(n.leadActivo);b({conversacion:i}),ae(a,i.mensajes),i.turno_en_proceso?_||(_=setTimeout(()=>P(t,!0),re)):(_&&(clearTimeout(_),_=null),P(t,!1)),O?o.classList.add("visible"):e.scrollTop=e.scrollHeight}catch(i){i instanceof h&&i.estadoHTTP>=500&&C("Error de conexión. Reintentando…")}}async function B(a){const e=a.value.trim();if(!e)return;const t=S();if(t.leadActivo){a.value="";try{await p.enviarTexto(t.leadActivo,e)}catch(o){a.value=e,o instanceof h&&C(o.message)}}}async function de(a,e,t,o,n){try{const i=await navigator.mediaDevices.getUserMedia({audio:!0});v=new MediaRecorder(i),E=[],g=0,v.ondataavailable=s=>{E.push(s.data)},v.onstop=()=>{i.getTracks().forEach(s=>s.stop()),le(a,e,o,n)},v.start(),a.style.display="none",o.style.display="none",n.style.display="none",e.classList.add("activo"),t.textContent="0:00",T=setInterval(()=>{g++;const s=Math.floor(g/60),r=g%60;t.textContent=`${s}:${r.toString().padStart(2,"0")}`,g>=ie&&q(a,e,o,n)},1e3)}catch{C("No se pudo acceder al micrófono.")}}function q(a,e,t,o){T&&(clearInterval(T),T=null),v&&v.state!=="inactive"&&v.stop(),e.classList.remove("activo"),a.style.display="",t.style.display="",o.style.display=""}async function le(a,e,t,o){if(E.length===0)return;const n=S();if(!n.leadActivo)return;const i=new Blob(E,{type:E[0].type}),s=new FileReader;s.onloadend=async()=>{const r=s.result.split(",")[1],c=i.type,d=g;try{await p.enviarAudio(n.leadActivo,r,c,d)}catch(l){l instanceof h&&(l.codigo==="AUDIO_INVALIDO"?C("No te escuché bien, ¿me lo repites o me lo escribes?"):C(l.message))}},s.readAsDataURL(i),e.classList.remove("activo"),a.style.display="",t.style.display="",o.style.display=""}function C(a){const e=document.querySelector(".toast-error");e&&e.remove();const t=document.createElement("div");t.className="toast-error",t.textContent=a,document.body.appendChild(t),setTimeout(()=>t.remove(),4e3)}const ue={VERDE:"🟢",AMBAR:"🟡",GRIS:"⚪"};function me(a,e,t,o){const n=e.cupo_10.usados,i=e.cupo_10.porcentaje_ventana,r=n/(i||1)*100>=80;a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-lead-id]").forEach(c=>{const d=c.dataset.leadId,l=c.querySelector("[data-btn-chat]");l&&l.addEventListener("click",u=>{u.stopPropagation(),o(d)}),c.addEventListener("click",()=>t(d)),c.addEventListener("keydown",u=>{(u.key==="Enter"||u.key===" ")&&(u.preventDefault(),t(d))})})}function pe(a){const e=ue[a.semaforo]??"⚪";return`
    <li class="fila-lead" data-lead-id="${a.lead_id}" tabindex="0" role="listitem">
      ...
      <span class="lead-nombre">${$(a.nombre)}</span>
      <span class="lead-ruta">${$(a.ruta)}</span>
      <span class="lead-prio-badge" title="Prioridad calculada">Prio ${a.prioridad.toFixed(2)}</span>
      <button class="btn-ver-chat" data-btn-chat="true" title="Ver chat en vivo con ${$(a.nombre)}" type="button">
        💬 Ver chat
      </button>
      <p class="lead-resumen">${$(a.resumen)}</p>
    </li>
  `}function $(a){const e=document.createElement("div");return e.textContent=a,e.innerHTML}const k={VERIFICADO_BASE:{txt:"VERIFICADO",icono:"✓",clase:"badge-verificado"},DECLARADO:{txt:"DECLARADO",icono:"✍",clase:"badge-declarado"},INFERIDO:{txt:"INFERIDO",icono:"~",clase:"badge-inferido"}};function I(a){const e=k[a]??k.DECLARADO;return`<span class="badge-fuente ${e.clase}" title="Fuente: ${e.txt}">${e.icono} ${e.txt}</span>`}function F(a,e,t="Lead"){if(!e){fe(a,t);return}const o=e.banda_advertencia?`<div class="banda-advertencia" role="alert">
      ...
      <div class="grid-tres-columnas">
        ...
        <article class="card-seccion">
          ...
          <div class="desglose-monto-item">
            ...
            <span class="monto-num">$${(s.presupuesto_max/1e6).toFixed(1)}M ${I("VERIFICADO_BASE")}</span>
          </div>
          <div class="desglose-monto-item">
            <span>Crédito Máx:</span>
            <span class="monto-num">$${(s.credito_max/1e6).toFixed(1)}M ${I("INFERIDO")}</span>
          </div>
          <div class="desglose-monto-item">
            <span>Subsidio Aplicable:</span>
            <span class="monto-num">$${(s.subsidio_aplicable/1e6).toFixed(1)}M ${I("VERIFICADO_BASE")}</span>
          </div>
          <div class="desglose-monto-item">
            <span>Recursos Propios:</span>
            <span class="monto-num">$${(s.recursos_propios/1e6).toFixed(1)}M ${I("DECLARADO")}</span>
          </div>
        </article>
        ...
        <article class="card-seccion">
          ...
          <ul class="lista-puntos">
            ${r.senales.map(d=>`<li>${m(d)}</li>`).join("")}
          </ul>
        </article>
        ...
        <article class="card-seccion">
          ...
          <ul class="lista-puntos">
            ${e.argumentos_venta.map(d=>`<li>${m(d)}</li>`).join("")}
          </ul>
          <h4 style="margin-top:0.5rem">Beneficios Colsubsidio</h4>
          <ul class="lista-puntos">
            ${e.beneficios.map(d=>`<li>${m(d)}</li>`).join("")}
          </ul>
        </article>
      </div>
  ...
  `;const c=a.querySelector("#btn-copiar-resumen");c&&c.addEventListener("click",()=>{const d=`RESUMEN FICHA - ${i.nombre}
Presupuesto: $${(s.presupuesto_max/1e6).toFixed(1)}M | Afiliada: ${i.afiliada?"Sí":"No"}
Intención: ${r.nivel}
Siguiente paso: Agendar visita sala de ventas.`;navigator.clipboard.writeText(d).then(()=>{c.textContent="✓ Copiado!",setTimeout(()=>{c.textContent="📋 Copiar Resumen"},2e3)})})}function fe(a,e){a.innerHTML=`
      ...
      <header class="gerencia-header">
        <div class="selector-proyecto-wrap">
          ...
          <select id="select-proyecto-gerencia" class="select-proyecto">
            ${ve.map(l=>`
              <option value="${l.id}" ${l.id===t?"selected":""}>
                ${U(l.nombre)}
              </option>
            `).join("")}
          </select>
  ...
  `;const d=a.querySelector("#select-proyecto-gerencia");d&&d.addEventListener("change",()=>{o(d.value)})}function R(a){const e=Math.max(...Object.values(a),1);return Object.entries(a).map(([t,o])=>{const n=(o/e*100).toFixed(0);return`
      <div class="barra-item">
        <span class="barra-label">${U(t)}</span>
        <div class="barra-track">
          <div class="barra-fill" style="width: ${n}%"></div>
        </div>
        <span class="barra-val">${o}</span>
      </div>
    `}).join("")}function U(a){const e=document.createElement("div");return e.textContent=a,e.innerHTML}function be(a,e,t){a.innerHTML=`
  ...
  `;const o=a.querySelector("#btn-avanzar-tiempo");o&&o.addEventListener("click",e);const n=a.querySelector("#btn-reiniciar-demo");n&&n.addEventListener("click",t)}const ge=5e3;let x="mongui";function he(a,e,t){if(t){const o=t.querySelectorAll("button[data-tab]");o.forEach(n=>{n.addEventListener("click",()=>{const i=n.dataset.tab;_e(i,o)})})}e&&Ce(e),Z(()=>H(a)),setInterval(()=>L(),ge),L(),H(a)}async function L(){try{const a=await p.cola();b({cola:a})}catch(a){console.warn("[dashboard] Error cargando cola:",a)}}function _e(a,e){b({tabActiva:a}),e.forEach(t=>{const o=t.dataset.tab===a;t.setAttribute("aria-selected",o?"true":"false")})}function H(a){const e=S();switch(e.tabActiva){case"cola":e.cola?me(a,e.cola,t=>ye(t),t=>Ae(t)):a.innerHTML='<div style="padding:1rem; color:#6B7280">Cargando cola de leads…</div>';break;case"ficha":e.leadActivo?Ee(a,e.leadActivo):a.innerHTML='<div style="padding:1.5rem; text-align:center; color:#6B7280">Selecciona un lead de la cola para ver su ficha comercial.</div>';break;case"gerencia":j(a,x);break}}function ye(a){b({leadActivo:a,tabActiva:"ficha"});const e=document.querySelector(".tabs");e&&e.querySelectorAll("button[data-tab]").forEach(o=>o.setAttribute("aria-selected",o.dataset.tab==="ficha"?"true":"false"))}function Ae(a){b({leadActivo:a});const e=document.getElementById("panel-chat");e&&e.scrollIntoView({behavior:"smooth"})}async function Ee(a,e){var i;const o=(i=S().cola)==null?void 0:i.leads.find(s=>s.lead_id===e),n=(o==null?void 0:o.nombre)??"Lead";try{const s=await p.ficha(e);F(a,s,n)}catch(s){s instanceof h&&s.estadoHTTP===404?F(a,null,n):a.innerHTML=`<div class="banda-advertencia">⚠️ Error cargando la ficha comercial: ${s.message}</div>`}}async function j(a,e){try{const t=await p.buyerPersona(e);V(a,t,e,o=>{x=o,j(a,o)})}catch{V(a,null,e,t=>{x=t,j(a,t)})}}function Ce(a){be(a,async()=>{const e=prompt("Avanzar fecha/tiempo simulado (formato ISO, ej: 2026-08-01):","2026-08-01");if(e)try{await p.avanzarTiempo(e),alert(`Tiempo avanzado exitosamente a ${e}.`),L()}catch(t){alert(`Error al avanzar tiempo: ${t.message}`)}},async()=>{try{await p.reiniciar();let e=null;try{e=(await p.crearLead("ana")).lead_id}catch(t){console.error("[dashboard] no se pudo recrear el lead tras reiniciar:",t)}b({leadActivo:e,tabActiva:"cola"}),L(),alert("Demo reiniciado al estado inicial.")}catch(e){alert(`Error al reiniciar demo: ${e.message}`)}})}const J=new URLSearchParams(location.search);J.get("mock")==="1"&&Q();const Se=["ana","carlos","luisa"];function $e(){const a=J.get("precargado");return Se.includes(a??"")?a:"ana"}async function Ie(){try{return(await p.crearLead($e())).lead_id}catch(a){const e=a instanceof h?`${a.codigo}: ${a.message}`:String(a);return console.error("[main] no se pudo crear el lead inicial:",e),Oe(e),null}}function Oe(a){const e=document.getElementById("panel-chat");if(!e)return;const t=document.createElement("div");t.className="banda-advertencia",t.setAttribute("role","alert"),t.textContent=`No se pudo iniciar la conversación (${a}). Recargá la página o revisá que el backend esté arriba.`,e.prepend(t)}async function Te(){const a=document.getElementById("panel-chat");if(a){const n=await Ie();n&&(b({leadActivo:n}),ce(a))}const e=document.getElementById("contenido-tab"),t=document.querySelector(".tabs"),o=document.getElementById("botonera-demo");e&&he(e,o,t),console.info("Vivi web iniciado completo (Chat + Dashboard)")}Te();
